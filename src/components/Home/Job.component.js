        ...
        <div style={{ minHeight: "600px" }}>
            {
                jobs.length === 0 ? <div className='d-flex justify-content-center align-items-center' style={{ height: "86vh" }}>
                    ...
                    <div className="container mt-4">
                        ...
                        <input type="text" className='form-control mt-4 mb-2 py-3' placeholder='Search by company name, job type, skills, position, salary or location' value={value} onChange={filterData} style={{ boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}} />
                            <div className="row">
