...
const JobCard = (props) => {
    ...
    const apply = (id) => {
        const getDate = new Date((deadline).split('T')[0])
        ...
        if (nowDate > getDate) {
            swal("warning", "deadline is over!", "error")
        } else {
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        ...
                        <div className='d-flex justify-content-between mt-3'>
                            <span onClick={() => details(_id)} className='btn btn-sm btn-info text-white fw-bold pt-2 px-2'>Details <MdReportGmailerrorred size="20" className='mb-1' /></span>
