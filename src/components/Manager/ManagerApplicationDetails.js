...
const ManagerApplicationDetails = () => {
    ...
    useEffect(() => {
        axios.get(`https://jobportal-api.onrender.com/api/manager/application/${id}`)
            .then(res => {
                if(res.data.error){
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="col-md-3">
                                    <Link to="/dashboard/manager/job" className='text-decoration-none'>
                                        <div className='a-box d-flex justify-content-center align-items-center'>
                                            <h4 className='fw-bold'><AiFillAppstore size="22px" className='mb-2' />All Job</h4>
                                        </div>
                                    </Link>
                                </div>
                                <div className="col-md-3">
                                    <Link to="/dashboard/manager/application" className='text-decoration-none'>
                                        <div className='a-box d-flex justify-content-center align-items-center'>
                                            <h4 className='fw-bold'><AiFillAppstore size="22px" className='mb-2' />All Application</h4>
                                        </div>
                                    </Link>
                                </div>
                            </div>
