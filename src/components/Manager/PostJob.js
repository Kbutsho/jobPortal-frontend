                    ...
                    <form onSubmit={submit} className='py-3 px-5' style={loading ? { background: "#F5F7FC" } : { background: "rgba(0, 0, 0, 0.1)" }}>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <input type="text" placeholder='Position Name' value={value.name} name='name' className='form-control my-3' onChange={inputChange} />
                                ...
                                <input type="number" placeholder='Salary' value={value.salary} name='salary' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.salary ? <span className='mt-1'>{value.errors.salary}</span> : null}</span>
                                <input type="text" placeholder='Location' value={value.location} name='location' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.location ? <span className='mt-1'>{value.errors.location}</span> : null}</span>
                                <input type="text" placeholder='Vacancy' value={value.vacancy} name='vacancy' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.vacancy ? <span className='mt-1'>{value.errors.vacancy}</span> : null}</span>
                                <input type="date" placeholder='Deadline' value={value.deadline} name='deadline' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.deadline ? <span className='mt-1'>{value.errors.deadline}</span> : null}</span>
                                <input type="text" placeholder='Skills' value={value.Skills} name='Skills' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.Skills ? <span className='mt-1'>{value.errors.Skills}</span> : null}</span>
                            </div>
                            <div className="col-md-6">
                                <input type="text" placeholder='Company Name' value={value.companyName} name='companyName' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.companyName ? <span className='mt-1'>{value.errors.companyName}</span> : null}</span>
                                <input type="text" placeholder='Company Details' value={value.companyDetails} name='companyDetails' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.companyDetails ? <span className='mt-1'>{value.errors.companyDetails}</span> : null}</span>
                                <input type="text" placeholder='Job Description' value={value.jobDescription} name='jobDescription' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.jobDescription ? <span className='mt-1'>{value.errors.jobDescription}</span> : null}</span>
                                <input type="text" placeholder='job Responsibilities' value={value.jobResponsibilities} name='jobResponsibilities' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.jobResponsibilities ? <span className='mt-1'>{value.errors.jobResponsibilities}</span> : null}</span>
                                <input type="text" placeholder='Additional Requirements' value={value.additionalRequirements} name='additionalRequirements' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
                                }}>{value.errors.additionalRequirements ? <span className='mt-1'>{value.errors.additionalRequirements}</span> : null}</span>
                                <input type="text" placeholder='Benefits' value={value.benefits} name='benefits' className='form-control my-3' onChange={inputChange} />
                                <span className='' style={{
                                    color: "red", fontSize: "12px", fontWeight: "bold"
